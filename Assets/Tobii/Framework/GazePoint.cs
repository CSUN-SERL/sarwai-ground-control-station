...
namespace Tobii.Framework
{
    ...
    public struct GazePoint : ITimestamped
    {
        ...
        ///     The timestamp when the gaze point was created in the eye tracker, in seconds
        ///     <see cref="Time.unscaledTime" />.
        /// </param>
        public GazePoint(Vector2 viewportCoordinates, float timestamp,
        ...
        public static GazePoint Invalid
        {
            get
            {
                return new GazePoint(new Vector2(float.NaN, float.NaN), -1.0f,
                    -1);
            }
        }
