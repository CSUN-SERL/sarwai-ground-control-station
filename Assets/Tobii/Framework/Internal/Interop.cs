...
namespace Tobii.Framework.Internal
{
    ...
    {
        public const string TobiiGameIntegrationCoreExtensionDll =
            "Tobii.GameIntegration.dll";

        private const int BufferSize = 64;

        private static readonly List<GazePoint> GazePointsBuffer =
            new List<GazePoint>(BufferSize);

        private static readonly List<HeadPose> HeadPosesBuffer =
            new List<HeadPose>(BufferSize);

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl, EntryPoint = "Start")]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool Start(
            [MarshalAs(UnmanagedType.I1)] bool custom_thread);

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "SetWindow")]
        public static extern void SetWindow(IntPtr hWnd);

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl, EntryPoint = "Stop")]
        public static extern void Stop();

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "SubscribeToStream")]
        public static extern void SubscribeToStream(TobiiSubscription stream);

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "UnsubscribeFromStream")]
        public static extern void UnsubscribeFromStream(
            TobiiSubscription stream);

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl, EntryPoint = "Update")]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool Update();

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "GetNewGazePoints")]
        private static extern void GetNewGazePointsInternal(
            out IntPtr gazePoints, out int numberOfAvailableGazePoints,
            UnitType unitType);
        ...
        public static List<GazePoint> GetNewGazePoints(UnitType unitType)
        {
            ...
            IntPtr ptr;
            GetNewGazePointsInternal(out ptr, out numberOfAvailableGazePoints,
                unitType);
            var longPtr = ptr.ToInt64();
            for (var i = 0; i < numberOfAvailableGazePoints; i++)
            {
                var currentPtr = new IntPtr(longPtr);
                GazePointsBuffer.Add(
                    (GazePoint) Marshal.PtrToStructure(currentPtr,
                        typeof(GazePoint)));
        ...
        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "GetNewHeadPoses")]
        private static extern void GetNewHeadPosesInternal(out IntPtr headPoses,
            out int numberOfAvailableHeadPoses);
        ...
        public static List<HeadPose> GetNewHeadPoses()
        {
            ...
            for (var i = 0; i < numberOfAvailableHeadPoses; i++)
            {
                var currentPtr = new IntPtr(longPtr);
                HeadPosesBuffer.Add(
                    (HeadPose) Marshal.PtrToStructure(currentPtr,
                        typeof(HeadPose)));
        ...
        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "GetUserPresence")]
        public static extern UserPresence GetUserPresence();

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "WasUpdated")]
        [return: MarshalAs(UnmanagedType.I1)]
        public static extern bool WasUpdated();

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "TimeSinceLastGazePacket")]
        public static extern float TimeSinceLastGazePacket();

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "TimeSinceLastHeadPacket")]
        public static extern float TimeSinceLastHeadPacket();

        [DllImport(TobiiGameIntegrationCoreExtensionDll,
            CallingConvention = CallingConvention.Cdecl,
            EntryPoint = "GetScreenSizeMm")]
        public static extern void
            GetScreenSizeMm(out int width, out int height);
    }

    public enum TobiiSubscription
    {
    ...
    {
        SignedNormalized =
            0, //  gaze position, signed normalized, client window bottom, left = (-1, -1), client window top, right = (1, 1)
