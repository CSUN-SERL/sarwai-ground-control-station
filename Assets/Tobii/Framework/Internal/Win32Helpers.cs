...
namespace Tobii.Framework.Internal
{
    ...
    internal static class Win32Helpers
    {
        ...
        [DllImport("user32.dll")]
        public static extern bool GetMonitorInfo(IntPtr hMonitor,
        ...
        [DllImport("user32.dll")]
        public static extern bool EnumWindows(EnumWindowsProc enumProc,
            IntPtr lParam);
        ...
        [DllImport("user32.dll", SetLastError = true)]
        public static extern bool ShowWindowAsync(IntPtr windowHandle,
            int nCmdShow);
        ...
        [DllImport("user32.dll")]
        public static extern bool GetClientRect(IntPtr _hwnd,
            ref RECT windowClientRect);

        [DllImport("user32.dll")]
        public static extern bool LogicalToPhysicalPoint(IntPtr hWnd,
            ref POINT lpPoint);
