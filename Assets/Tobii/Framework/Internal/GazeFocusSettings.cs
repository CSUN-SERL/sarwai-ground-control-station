...
namespace Tobii.Framework.Internal
{
	...
	public struct GazeFocusSettings
	{
		...
		private static readonly string DirectoryPath =
			"Assets" + Path.DirectorySeparatorChar + "Tobii" +
			Path.DirectorySeparatorChar + "Resources";

		private static readonly string FilePath =
			DirectoryPath + Path.DirectorySeparatorChar + ResourcePath +
			".json";
#endif
		...
		public static GazeFocusSettings Get()
		{
			...
			return GetSettingsFromObject(null/*SimpleJSON.JSON.Parse(settings.text)*/);
#endif
		}
		...
		{
			var layerMask = 0;
			for (var i = 0; i < MaximumLayersInUnity; ++i)
