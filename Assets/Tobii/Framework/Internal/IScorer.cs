...
namespace Tobii.Framework.Internal
{
    internal interface IScorer
    {
        ...
        /// <param name="camera">The camera that defines the participant's current view point.</param>
        /// <returns>
        ///     The <see cref="GameObject" /> with gaze focus if one found, null
        ///     otherwise.
        /// </returns>
        FocusedObject GetFocusedObject(
            IEnumerable<Framework.GazePoint> lastGazePoints, Camera camera);
        ...
        /// <param name="camera">The camera that defines the participant's current view point.</param>
        /// <returns></returns>
        IEnumerable<GameObject> GetObjectsInGaze(
            IEnumerable<Framework.GazePoint> lastGazePoints, Camera camera);
