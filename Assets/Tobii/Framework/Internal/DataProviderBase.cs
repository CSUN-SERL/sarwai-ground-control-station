...
namespace Tobii.Framework.Internal
{
        ...
        where T : ITimestamped
    {
        ...
        {
            if (!_isLastReadInFrame) return Last;
        ...
        public IEnumerable<T> GetDataPointsSince(ITimestamped dataPoint)
        {
            var dataPointTimestamp =
                dataPoint.IsValid ? dataPoint.Timestamp : 0.0;
        ...
        public void Start(int subscriberId)
        {
            ...
            if (oldCount == 0 && _subscribers.Count == 1) OnStreamingStarted();
        }
        ...
        public void Stop(int subscriberId)
        {
            ...
            if (_subscribers.Count == 0) OnStreamingStopped();
        }
        ...
        {
            _lastDataPoints.RemoveAll(point =>
