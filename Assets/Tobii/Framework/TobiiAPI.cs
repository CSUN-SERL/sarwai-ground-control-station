...
using UserPresence = Tobii.Framework.UserPresence;
...
namespace Assets.Tobii.Framework
{
    ...
    public static class TobiiAPI
    {
        ...
        {
            get { return TobiiHost.GetInstance(); }
        }
        ...
        /// <summary>
        ///     Get the participant presence, which indicates if there is a participant present
        ...
        /// </summary>
        /// <returns>
        ///     The gaze-aware game object that has gaze focus,
        ///     or null if no gaze-aware object is focused.
        /// </returns>
        public static GameObject GetFocusedObject()
        {
            SubscribeGazePointData();
            var focusedObject = Host.GazeFocus.FocusedObject;
            if (!focusedObject.IsValid) return null;

            return focusedObject.GameObject;
        }

        /// <summary>
        ///     Sets the camera that defines the participant's current view point.
        /// </summary>
        ...
        {
            SubscribeGazePointData();
            return Host.GetGazePointDataProvider()
                .GetDataPointsSince(gazePoint);
        }
