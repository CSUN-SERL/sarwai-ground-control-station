...
namespace Tobii.Framework
{
    ...
    public struct HeadPose : ITimestamped
    {
        ...
        /// </summary>
        /// <param name="position">
        ///     Head position: the x, y and z coordinate of the head of the participant (in millimeters from the
        ///     center of the display area)
        /// </param>
        /// <param name="rotation">
        ///     Head rotation: the x, y and z rotation of the head of the participant (expressed in Euler angles
        ///     using the right-hand rule. The z rotation describes the rotation around the vector that points out from the screen
        ///     in front of the participant, towards the participant)
        /// </param>
        /// <param name="timestamp">
        ///     The timestamp when the head pose data point was created in the eye tracker, in seconds
        ///     <see cref="Time.unscaledTime" />.
        /// </param>
        public HeadPose(Vector3 position, Quaternion rotation, float timestamp,
            long preciseTimestamp) : this()
        {
            Position = position;
            Rotation = rotation;
            Timestamp = timestamp;
        ...
        public static HeadPose Invalid
        {
            get
            {
                return new HeadPose(
                    ...
                    Quaternion.identity, -1.0f, -1);
            }
        }

        /// <summary>
        ///     Head position: the x, y and z coordinate of the head of the participant, in
        ///     millimeters from the center of the display area.
        /// </summary>
        public Vector3 Position { get; private set; }

        /// <summary>
        ///     Head rotation: rotation of the head of the participant. Expressed using Quaternion.
        /// </summary>
        ...
        public bool IsValid
        {
            get { return !float.IsNaN(Position.x); }
        }
