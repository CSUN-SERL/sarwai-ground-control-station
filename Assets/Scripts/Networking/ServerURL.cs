namespace Networking
{
	public class ServerURL
	{
	    ...
	    public const string ServerSelection = "Azeroth";
        ...
        // Remote Server
        //public const string URL = "http://13.56.60.57";
	    ...
	    private static readonly string[] ROBOT_LIVE_FEED_URLS = { "192.168.1.43", "192.168.1.43", "192.168.1.43", "192.168.1.43" };
	    private static readonly int[] ROBOT_LIVE_FEED_PORTS = {8081, 8082, 8083, 8084};
